...
export const deletProductCart = async (req, res) => {
    ...
    try {
        ...
        const result = await carts.deletProductCart(cid, pid)
...
export const overwriteCart= async (req, res) => {
    ...
    try {
        ...
        const result = await carts.overwriteCart(cid, req.body)
...
export const uptadeQuantityProduct= async (req, res) => {
    ...
    try {
        ...
        const result = await carts.uptadeQuantity(cid,pid,quantity);
